...
test('\nresolving a "/*# sourceMappingURL=map-file-comment.scss.map*/" style comment inside a given scss content', function (t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment.scss', 'utf8')
  ...
  t.equal(sm.file, 'map-file-comment.scss', 'includes filename of generated file')
  t.equal(
      sm.mappings
...
test('\nresolving a "//# sourceMappingURL=map-file-comment.scss.map" style comment inside a given scss content', function (t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-double-slash.scss', 'utf8')
  var conv = convert.fromMapFileSource(css, __dirname + '/fixtures');
  var sm = conv.toObject();
...
test('\nresolving a /*# sourceMappingURL=data:application/json;base64,... */ style comment inside a given scss content', function(t) {
  var css = fs.readFileSync(__dirname + '/fixtures/map-file-comment-inline.scss', 'utf8')
